...
#   [ ][ ][ ][1][2][3][ ]
#
# If two elements are then read, or removed from the buffer, the oldest values inside the buffer are removed. The two elements
...
#   [6][7][8][9][3][4][5]
#
# When the buffer is full an error will be raised, alerting the client that further writes are blocked until a slot becomes 
# free.
#
